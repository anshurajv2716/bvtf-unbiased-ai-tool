...
#          python-dotenv
# RUN: streamlit run bvtf_gemini_app.py
# ============================================================
...
st.set_page_config(
    page_title="Unbiased AI Decision Tool — BV TechFusion 2026",
    page_icon="⚖️",
    layout="wide",
...
def make_charts(results, sector, protected_attr, group_names, outcome_name, config):
    ...
    fig.suptitle(
        ...
        f'BV TechFusion 2026  |  Team Solvation  |  Gemini AI + IBM AIF360',
    ...
    ax3.text(5, 1.2, 'BV TechFusion 2026',
...
<div class="hero-header">
    ...
    <p>BV TechFusion 2026 — Team Solvation</p>
        ...
        if btn:
            ...
            if 'error' in res:
                ...
                <div class="alert-success" style="margin-top:1rem;">
                    ✅ Analysis complete! Bias mitigated | {cfg['sdg']} | BV TechFusion 2026
                </div>""", unsafe_allow_html=True)
